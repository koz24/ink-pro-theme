...
if ( $overlay ) {
	...
	$output .= '<div style="' . esc_attr( $overlay_style ) . '" class="wolf-vc-row-overlay"></div><!--.wolf-vc-row-overlay-->';
}

$output .= '<div class="wolf-vc-row-container">';

$output .= '<div style="' . esc_attr( $custom_style ) . '" class="wolf-vc-row-inner ' . esc_attr( $content_type . '-width wolf-vc-font-' . $font_color ) . '">';

$output .= wpb_js_remove_wpautop( $content );

$output .= '</div><!--.wolf-vc-row-inner-->';
$output .= '</div><!--.wolf-vc-row-container-->';
