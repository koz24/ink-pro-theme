<?php
/**
 * WolfFramework category meta class
 *
 * @package WordPress
			...
			foreach ( $this->cat_meta as $field ) {
				...
				echo '</label>';
					...
					if ( 'text' == $type || 'int' == $type ) {
						...
						?>
						<input name="wolf_post_category_meta[<?php echo sanitize_title( $field_id ) . '_color'; ?>]" class="wolf-settings-colorpicker" type="text">
						<?php
						...
						<img style="max-width:250px;display:none;" class="wolf-settings-img-preview" src="" alt="<?php echo sanitize_title( $field_id ); ?>">
						<br><a href="#" class="button wolf-settings-reset-bg"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
						<a href="#" class="button wolf-settings-set-bg"><?php esc_html_e( 'Choose an image', 'inkpro' ); ?></a>
						<?php
						...
						<div>
							...
							<br><a href="#" class="button wolf-settings-reset-file"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
							<a href="#" class="button wolf-settings-set-file"><?php esc_html_e( 'Choose a file', 'inkpro' ); ?></a>
							<br><br>
						</div>
						...
						<input type="hidden"  name="wolf_post_category_meta[<?php echo sanitize_title( $field_id ) . '_img'; ?>]" id="wolf_post_category_meta[<?php echo sanitize_title( $field_id ) . '_img'; ?>]">
						<img style="max-width:200px;display:none" src="" class="wolf-settings-img-preview">
						<br><a href="#" class="button wolf-settings-reset-img"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
						<a href="#" class="button wolf-settings-set-img"><?php esc_html_e( 'Choose an image', 'inkpro' ); ?></a>
						</div>
						<?php
			...
			foreach ( $this->cat_meta as $field ) {
				...
				echo '</label></th><td>';
					...
					if ( 'text' == $type || 'int' == $type ) {
						...
						?>
						<input name="wolf_post_category_meta[<?php echo sanitize_title( $field_id ); ?>]" class="wolf-settings-colorpicker" type="text" value="<?php echo esc_attr( $value ); ?>">
						<?php
						...
						if ( ! in_array( 'color', $exclude_params ) ) {
							...
							<br><br>
							<p><?php esc_html_e( 'Background color', 'inkpro' ); ?></p>
							<input name="wolf_post_category_meta[<?php echo sanitize_title( $field_id ) . '_color'; ?>]" class="wolf-settings-colorpicker" type="text" value="<?php echo esc_attr( $bg_meta_color ); ?>">
							<br><br>
							<?php
						}
						...
						if ( ! in_array( 'image', $exclude_params ) ) {
							...
							<div>
								...
								<img style="max-width:250px;<?php if ( 0 == $bg_meta_img_id ) echo ' display:none;'; ?>" class="wolf-settings-img-preview" src="<?php echo esc_url( $bg_meta_img_url ); ?>" alt="<?php echo sanitize_title( $field_id ); ?>">
								<br><a href="#" class="button wolf-settings-reset-bg"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
								<a href="#" class="button wolf-settings-set-bg"><?php esc_html_e( 'Choose an image', 'inkpro' ); ?></a>
							</div>
							<br><br>
						...
						<img style="max-width:200px;<?php echo ( ! $img ) ? 'display:none;' : '' ?>" src="<?php echo esc_url( $img ); ?>" class="wolf-settings-img-preview">
						<br><a href="#" class="button wolf-settings-reset-img"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
						<a href="#" class="button wolf-settings-set-img"><?php esc_html_e( 'Choose an image', 'inkpro' ); ?></a>
						</div>
						<?php
