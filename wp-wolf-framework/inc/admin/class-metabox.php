...
if ( ! class_exists( 'Wolf_Theme_Admin_Metabox' ) ) {
	...
	class Wolf_Theme_Admin_Metabox {
		...
		public function render() {
			...
			echo '<table class="form-table inkpro-metabox-table">';

			foreach ( $this->meta as $k => $v ) {

				if ( isset( $v['help'] ) ) {
					echo '<div class="inkpro-metabox-help">' . $v['help'] . '</div>';
				}
			}
			...
			foreach ( $meta_fields as $field ) {
				...
				<td>";
					...
					// colorpicker
						...
						echo '<input type="text" class="inkpro-options-colorpicker inkpro-colorpicker-input" name="' . $field_id . '" id="' . $field_id . '" value="' . $meta . '" />
						<br><span class="description">' . $desc . '</span>';
					...
					<div>
						...
						<br><a href="#" class="button inkpro-options-reset-file"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
						<a href="#" class="button inkpro-options-set-file"><?php esc_html_e( 'Choose a file', 'inkpro' ); ?></a>
					</div>
					...
					<div>
						...
						<img style="max-width:250px;<?php if ( 0 == $meta_img ) echo ' display:none;'; ?>" class="inkpro-options-img-preview" src="<?php echo esc_url( $meta_img_url ); ?>" alt="<?php echo esc_attr( $field_id ); ?>">
						<br><a href="#" class="button inkpro-options-reset-img"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
						<a href="#" class="button inkpro-options-set-img"><?php esc_html_e( 'Choose an image', 'inkpro' ); ?></a>
					</div>
					...
					-------------------------------------------*/
						...
						?>
						<p><?php esc_html_e( 'Background color', 'inkpro' ); ?></p>
						<input name="<?php echo esc_attr( $field_id . '_color' ); ?>" name="<?php echo esc_attr( $field_id . '_color' ); ?>" class="inkpro-options-colorpicker" type="text" value="<?php echo esc_attr( $bg_meta_color ); ?>">
						<br><br>
						<?php
						}
						...
						?>
						<p><?php esc_html_e( 'Background image', 'inkpro' ); ?></p>
						<div>
							<input type="hidden" name="<?php echo esc_attr( $field_id ); ?>_img" id="<?php echo esc_attr( $field_id ); ?>_img" value="<?php echo esc_attr( $img ); ?>">
							<img style="max-width:250px;<?php if ( ! $img ) echo ' display:none;'; ?>" class="inkpro-options-img-preview" src="<?php echo esc_url( $img_url ); ?>" alt="<?php echo esc_attr( $field_id ); ?>">
							<br><a href="#" class="button inkpro-options-reset-bg"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
							<a href="#" class="button inkpro-options-set-bg"><?php esc_html_e( 'Choose an image', 'inkpro' ); ?></a>
						</div>
						<br><br>
						<?php
						}
						...
						?>
						<br>
						<p><?php esc_html_e( 'Background repeat', 'inkpro' ); ?></p>
						...
						?>
						<br><br>
						<p><?php esc_html_e( 'Background position', 'inkpro' ); ?></p>
						...
						?>
						<br><br>
						<p><?php esc_html_e( 'Background size', 'inkpro' ); ?></p>
						...
						if ( $parallax ) {
							?>
							<br><br>
							<p><strong><?php esc_html_e( 'Parallax', 'inkpro' ); ?></strong></p>
					...
					-------------------------------------------*/
						...
						if ( ! in_array( 'color', $exclude_params ) ) {
						?>
						<p><?php esc_html_e( 'Font color', 'inkpro' ); ?></p>
						<input name="<?php echo esc_attr( $field_id ) . '_font_color'; ?>" name="<?php echo  $field_id . '_font_color'; ?>" class="inkpro-options-colorpicker" type="text" value="<?php echo esc_attr( $color ); ?>">
						<br><br>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font weight', 'inkpro' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'For example: 400 is normal, 700 is bold.The available font weights depend on the font.<br>Leave empty to use the theme default style', 'inkpro' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font transform', 'inkpro' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style in the theme options', 'inkpro' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font style', 'inkpro' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style defined in the theme options', 'inkpro' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font letter spacing (omit px)', 'inkpro' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'Leave empty to use the style defined in the theme options', 'inkpro' ); ?></span>
						<?php
						}
					...
					-------------------------------------------*/
						...
						?>
						<div>
							<p><strong><?php esc_html_e( 'mp4 URL', 'inkpro' ); ?></strong></p>
							<input type="text"  name="<?php echo esc_attr( $field_id ); ?>_mp4" id="<?php echo esc_attr( $field_id ); ?>_mp4" value="<?php echo esc_url( $mp4 ); ?>">
							<br><a href="#" class="button inkpro-options-reset-file"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
							<a href="#" class="button inkpro-options-set-video-file"><?php esc_html_e( 'Choose a file', 'inkpro' ); ?></a>
							<br><br>
						</div>

						<div>
							<p><strong><?php esc_html_e( 'webm URL', 'inkpro' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'ogv URL', 'inkpro' ); ?></strong></p>
						...
						<div>
						<p><strong><?php esc_html_e( 'Video Image Fallback', 'inkpro' ); ?></strong></p>
						<input type="hidden"  name="<?php echo esc_attr( $field_id ); ?>_img" id="<?php echo esc_attr( $field_id ); ?>_img" value="<?php echo esc_attr( $img ); ?>">
						<img style="max-width:200px;<?php echo ( ! $img ) ? 'display:none;' : '' ?>" src="<?php echo esc_url( $img_url ); ?>" class="inkpro-options-img-preview">
						<br><a href="#" class="button inkpro-options-reset-img"><?php esc_html_e( 'Clear', 'inkpro' ); ?></a>
						<a href="#" class="button inkpro-options-set-img"><?php esc_html_e( 'Choose an image', 'inkpro' ); ?></a>
						</div>
						<?php
