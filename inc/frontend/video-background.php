<?php
/**
 * InkPro video background function
 *
 * @package WordPress
 * @subpackage InkPro
 * @version 2.0.3
...
if ( ! function_exists( 'inkpro_video_bg' ) ) {
	/**
	 ...
	 */
	function inkpro_video_bg( $mp4 = null, $webm = null, $ogv = null, $img = null, $parallax = false ) {
...
if ( ! function_exists( 'inkpro_youtube_video_bg' ) ) {
	/**
	 ...
	 */
	function inkpro_youtube_video_bg( $url = null, $img_fallback = null, $parallax = false ) {
